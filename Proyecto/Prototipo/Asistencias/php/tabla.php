...
?>
	...
	<table class="table table-bordered table-hover ">
		...
		<?php
			...
			$sql = "SELECT P.NumeroPaciente, P.NombrePaciente, P.ApellidoPaterno,  P.ApellidoMaterno, P.Telefono, P.Diagnostico, SUM(PC.Asistencia), COUNT(PC.Asistencia) FROM Paciente P, Paciente_Consulta PC 
