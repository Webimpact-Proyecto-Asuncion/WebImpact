...
<?php
	...
	if(isset($_POST["consulta"])){
		...
		$sql = "SELECT  R.NumeroReporte, E.NombreEmpleado as 'Encargado', P.NombrePaciente as 'Nombre', P.ApellidoPaterno as 'A Paterno', P.ApellidoMaterno as 'A Materno', R.Edad, R.Valoracion, R.Terapia, R.Tratamiento, R.Avances, R.Fecha
